...
- `go test -coverprofile=coverage/archive_restore.coverprofile ./...`：通过；总覆盖率 40.8%（Agent 46.0%、Controller 20.2%、Store 60.1%），已覆盖持久会话/OAuth、活动租约/票据、enrollment、命令租约/围栏、Agent 重启去重、密文载荷、兼容 scrypt、快照发布、容量状态和 archive 恢复关键分支，但尚未达到最终 80% 覆盖率。
