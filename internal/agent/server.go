...
func (a *Agent) Handler() http.Handler {
	...
	mux.HandleFunc("POST "+peerOwnershipQueryRoute, a.handlePeerOwnershipQuery)
	mux.HandleFunc("POST "+peerOwnershipObserveRoute, a.handlePeerOwnershipObserve)
	mux.HandleFunc("POST "+adapterOwnershipResolveRoute, a.handleAdapterOwnershipResolve)
	mux.HandleFunc("POST "+adapterOwnershipTakeoverRoute, a.handleAdapterOwnershipTakeover)
